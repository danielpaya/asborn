...
const baseClasses =
  "focus-ring inline-flex items-center justify-center gap-2 min-h-11 px-7 py-3 label-caps border border-asbor-border text-asbor-ivory transition-all duration-200 hover:border-asbor-gold hover:text-asbor-gold active:scale-[0.98]";
